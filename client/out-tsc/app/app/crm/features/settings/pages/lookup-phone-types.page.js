...
const _c1 = () => [1, 2, 3];
const _c2 = () => ({ "min-width": "36rem" });
function LookupPhoneTypesPage_button_52_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 50);
    i0.ɵɵlistener("click", function LookupPhoneTypesPage_button_52_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.openCreate()); });
    i0.ɵɵelementStart(1, "span", 30);
    i0.ɵɵelement(2, "i", 51);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "span");
    i0.ɵɵtext(4, "New Phone Type");
    i0.ɵɵelementEnd()();
} }
function LookupPhoneTypesPage_div_53_p_skeleton_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "p-skeleton", 54);
} }
function LookupPhoneTypesPage_div_53_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 52);
    i0.ɵɵtemplate(1, LookupPhoneTypesPage_div_53_p_skeleton_1_Template, 1, 0, "p-skeleton", 53);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    i0.ɵɵadvance();
    i0.ɵɵproperty("ngForOf", i0.ɵɵpureFunction0(1, _c1));
} }
function LookupPhoneTypesPage_p_table_54_ng_template_1_th_9_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "th", 60);
    i0.ɵɵtext(1, "Actions");
    i0.ɵɵelementEnd();
} }
function LookupPhoneTypesPage_p_table_54_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(8, "Default");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(9, LookupPhoneTypesPage_p_table_54_ng_template_1_th_9_Template, 2, 0, "th", 59);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function LookupPhoneTypesPage_p_table_54_ng_template_2_p_tag_5_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "p-tag", 66);
} if (rf & 2) {
    i0.ɵɵproperty("rounded", true);
} }
function LookupPhoneTypesPage_p_table_54_ng_template_2_p_tag_6_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "p-tag", 67);
} if (rf & 2) {
    i0.ɵɵproperty("rounded", true);
} }
function LookupPhoneTypesPage_p_table_54_ng_template_2_p_tag_10_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "p-tag", 68);
} if (rf & 2) {
    i0.ɵɵproperty("rounded", true);
} }
function LookupPhoneTypesPage_p_table_54_ng_template_2_td_11_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "td")(1, "div", 69)(2, "button", 70);
    i0.ɵɵlistener("click", function LookupPhoneTypesPage_p_table_54_ng_template_2_td_11_Template_button_click_2_listener() { i0.ɵɵrestoreView(_r3); const row_r4 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.openEdit(row_r4)); });
    i0.ɵɵelement(3, "i", 71);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(4, "button", 72);
    i0.ɵɵlistener("click", function LookupPhoneTypesPage_p_table_54_ng_template_2_td_11_Template_button_click_4_listener() { i0.ɵɵrestoreView(_r3); const row_r4 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.deleteItem(row_r4)); });
    i0.ɵɵelement(5, "i", 73);
    i0.ɵɵelementEnd()()();
} }
function LookupPhoneTypesPage_p_table_54_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "tr", 61)(1, "td")(2, "strong");
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(4, "td");
    i0.ɵɵtemplate(5, LookupPhoneTypesPage_p_table_54_ng_template_2_p_tag_5_Template, 1, 1, "p-tag", 62)(6, LookupPhoneTypesPage_p_table_54_ng_template_2_p_tag_6_Template, 1, 1, "p-tag", 63);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(7, "td");
    i0.ɵɵtext(8);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(9, "td");
    i0.ɵɵtemplate(10, LookupPhoneTypesPage_p_table_54_ng_template_2_p_tag_10_Template, 1, 1, "p-tag", 64);
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(11, LookupPhoneTypesPage_p_table_54_ng_template_2_td_11_Template, 6, 0, "td", 65);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngIf", row_r4.isDefault);
    i0.ɵɵadvance();
    i0.ɵɵproperty("ngIf", ctx_r1.canManage());
} }
function LookupPhoneTypesPage_p_table_54_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "tr")(1, "td", 74);
    i0.ɵɵtext(2, "No phone types configured yet.");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
    i0.ɵɵattribute("colspan", ctx_r1.canManage() ? 5 : 4);
} }
function LookupPhoneTypesPage_p_table_54_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p-table", 55);
    i0.ɵɵtemplate(1, LookupPhoneTypesPage_p_table_54_ng_template_1_Template, 10, 1, "ng-template", 56)(2, LookupPhoneTypesPage_p_table_54_ng_template_2_Template, 12, 6, "ng-template", 57)(3, LookupPhoneTypesPage_p_table_54_ng_template_3_Template, 3, 1, "ng-template", 58);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
export class LookupPhoneTypesPage {
    ...
    loadItems() {
        ...
        this.dataService.getPhoneTypes(true).subscribe({
            next: (data) => { this.items.set(data ?? []); this.loading.set(false); },
            error: () => { this.loading.set(false); this.toast('error', 'Unable to load phone types'); }
        });
    }
    openCreate() {
        this.editing.set(null);
        this.form.reset({ name: '', isActive: true, sortOrder: this.nextOrder(), isDefault: false });
        this.editorOpen.set(true);
    }
    openEdit(item) {
        this.editing.set(item);
        this.form.reset({ name: item.name, isActive: item.isActive, sortOrder: item.sortOrder, isDefault: item.isDefault });
        this.editorOpen.set(true);
    }
    closeEditor() {
    ...
    save() {
        ...
        const req = current
            ? this.dataService.updatePhoneType(current.id, body)
            : this.dataService.createPhoneType(body);
        req.subscribe({
            next: () => {
                this.saving.set(false);
                this.toast('success', current ? 'Phone type updated' : 'Phone type created');
                this.closeEditor();
                this.loadItems();
            },
            error: (err) => {
                this.saving.set(false);
                this.toast('error', err?.error ?? 'Unable to save phone type');
            }
        });
    }
    deleteItem(item) {
        if (!this.canManage() || this.saving())
            return;
        if (item.isDefault) {
            this.toast('error', 'Cannot delete the default phone type');
            return;
        }
        if (!confirm(`Delete "${item.name}"?`))
            return;
        this.saving.set(true);
        this.dataService.deletePhoneType(item.id).subscribe({
            next: () => { this.saving.set(false); this.toast('success', 'Phone type deleted'); this.loadItems(); },
            error: (err) => { this.saving.set(false); this.toast('error', err?.error ?? 'Unable to delete phone type'); }
        });
    }
    nextOrder() {
    ...
    static ɵfac = function LookupPhoneTypesPage_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || LookupPhoneTypesPage)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: LookupPhoneTypesPage, selectors: [["app-lookup-phone-types-page"]], decls: 82, vars: 20, consts: [[1, "page-container"], [1, "bg-orbs"], [1, "orb", "orb-1"], [1, "orb", "orb-2"], [1, "orb", "orb-3"], [1, "hero-section"], [1, "hero-content"], ["routerLink", "/app/settings", 1, "back-link"], [1, "pi", "pi-arrow-left"], [1, "hero-badge"], [1, "badge-dot"], [1, "hero-title"], [1, "title-gradient"], [1, "title-light"], [1, "hero-description"], [1, "hero-visual"], [1, "visual-card", "visual-card--primary"], [1, "card-icon"], [1, "pi", "pi-phone"], [1, "card-content"], [1, "card-label"], [1, "card-value"], [1, "card-glow"], [1, "visual-card", "visual-card--success"], [1, "pi", "pi-check-circle"], [1, "data-section"], [1, "data-card"], [1, "data-header"], [1, "header-actions"], ["type", "button", 1, "action-btn", "action-btn--refresh", 3, "click", "disabled"], [1, "action-btn__icon"], [1, "pi", "pi-refresh"], ["type", "button", "class", "action-btn action-btn--add", 3, "click", 4, "ngIf"], ["class", "skeleton-rows", 4, "ngIf"], ["styleClass", "p-datatable-sm", 3, "value", "rows", "paginator", "rowHover", "tableStyle", 4, "ngIf"], [3, "visibleChange", "onHide", "header", "visible", "modal", "closable", "draggable"], [3, "ngSubmit", "formGroup"], [1, "dialog-body"], [1, "form-field"], ["for", "lu-name"], [1, "required"], [1, "icon-addon", "icon-addon--name"], ["pInputText", "", "id", "lu-name", "formControlName", "name", "placeholder", "e.g. Mobile"], ["for", "lu-sort"], ["id", "lu-sort", "formControlName", "sortOrder", 3, "min", "showButtons"], ["formControlName", "isActive", "label", "Active", 3, "binary"], ["formControlName", "isDefault", "label", "Default", 3, "binary"], [1, "dialog-footer"], ["type", "button", "pButton", "", "label", "Cancel", 1, "p-button-text", 3, "click"], ["type", "submit", "pButton", "", "label", "Save", "icon", "pi pi-check", 3, "loading"], ["type", "button", 1, "action-btn", "action-btn--add", 3, "click"], [1, "pi", "pi-plus"], [1, "skeleton-rows"], ["height", "3rem", "styleClass", "mb-2", 4, "ngFor", "ngForOf"], ["height", "3rem", "styleClass", "mb-2"], ["styleClass", "p-datatable-sm", 3, "value", "rows", "paginator", "rowHover", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], ["style", "width: 7rem", 4, "ngIf"], [2, "width", "7rem"], [1, "table-row"], ["severity", "success", "value", "Active", 3, "rounded", 4, "ngIf"], ["severity", "warn", "value", "Inactive", 3, "rounded", 4, "ngIf"], ["severity", "info", "value", "Default", 3, "rounded", 4, "ngIf"], [4, "ngIf"], ["severity", "success", "value", "Active", 3, "rounded"], ["severity", "warn", "value", "Inactive", 3, "rounded"], ["severity", "info", "value", "Default", 3, "rounded"], [1, "row-actions"], ["type", "button", "title", "Edit", 1, "row-action-btn", "row-action-btn--edit", 3, "click"], [1, "pi", "pi-pencil"], ["type", "button", "title", "Delete", 1, "row-action-btn", "row-action-btn--delete", 3, "click"], [1, "pi", "pi-trash"], [1, "empty-message"]], template: function LookupPhoneTypesPage_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵtext(45, "Phone Type List");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(46, "div", 28)(47, "button", 29);
            i0.ɵɵlistener("click", function LookupPhoneTypesPage_Template_button_click_47_listener() { return ctx.loadItems(); });
            ...
            i0.ɵɵelementEnd()();
            i0.ɵɵtemplate(52, LookupPhoneTypesPage_button_52_Template, 5, 0, "button", 32);
            i0.ɵɵelementEnd()();
            i0.ɵɵtemplate(53, LookupPhoneTypesPage_div_53_Template, 2, 2, "div", 33)(54, LookupPhoneTypesPage_p_table_54_Template, 4, 6, "p-table", 34);
            i0.ɵɵelementEnd()()();
            i0.ɵɵelementStart(55, "p-dialog", 35);
            i0.ɵɵtwoWayListener("visibleChange", function LookupPhoneTypesPage_Template_p_dialog_visibleChange_55_listener($event) { i0.ɵɵtwoWayBindingSet(ctx.editorOpen, $event) || (ctx.editorOpen = $event); return $event; });
            i0.ɵɵlistener("onHide", function LookupPhoneTypesPage_Template_p_dialog_onHide_55_listener() { return ctx.closeEditor(); });
            i0.ɵɵelementStart(56, "form", 36);
            i0.ɵɵlistener("ngSubmit", function LookupPhoneTypesPage_Template_form_ngSubmit_56_listener() { return ctx.save(); });
            ...
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(75, "div", 38)(76, "label");
            i0.ɵɵtext(77, "\u00A0");
            i0.ɵɵelementEnd();
            i0.ɵɵelement(78, "p-checkbox", 46);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(79, "div", 47)(80, "button", 48);
            i0.ɵɵlistener("click", function LookupPhoneTypesPage_Template_button_click_80_listener() { return ctx.closeEditor(); });
            i0.ɵɵelementEnd();
            i0.ɵɵelement(81, "button", 49);
            i0.ɵɵelementEnd()()();
        } if (rf & 2) {
            i0.ɵɵadvance(30);
            ...
            i0.ɵɵproperty("header", ctx.editing() ? "Edit Phone Type" : "New Phone Type");
