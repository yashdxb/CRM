...
function LookupAccountTypesPage_button_52_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 49);
    i0.ɵɵlistener("click", function LookupAccountTypesPage_button_52_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.openCreate()); });
    i0.ɵɵelementStart(1, "span", 30);
    i0.ɵɵelement(2, "i", 50);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "span");
    i0.ɵɵtext(4, "New Account Type");
    i0.ɵɵelementEnd()();
} }
function LookupAccountTypesPage_div_53_p_skeleton_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "p-skeleton", 53);
} }
function LookupAccountTypesPage_div_53_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 51);
    i0.ɵɵtemplate(1, LookupAccountTypesPage_div_53_p_skeleton_1_Template, 1, 0, "p-skeleton", 52);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    i0.ɵɵadvance();
    i0.ɵɵproperty("ngForOf", i0.ɵɵpureFunction0(1, _c1));
} }
function LookupAccountTypesPage_p_table_54_ng_template_1_th_7_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "th", 59);
    i0.ɵɵtext(1, "Actions");
    i0.ɵɵelementEnd();
} }
function LookupAccountTypesPage_p_table_54_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(7, LookupAccountTypesPage_p_table_54_ng_template_1_th_7_Template, 2, 0, "th", 58);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function LookupAccountTypesPage_p_table_54_ng_template_2_p_tag_5_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "p-tag", 64);
} if (rf & 2) {
    i0.ɵɵproperty("rounded", true);
} }
function LookupAccountTypesPage_p_table_54_ng_template_2_p_tag_6_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "p-tag", 65);
} if (rf & 2) {
    i0.ɵɵproperty("rounded", true);
} }
function LookupAccountTypesPage_p_table_54_ng_template_2_td_9_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "td")(1, "div", 66)(2, "button", 67);
    i0.ɵɵlistener("click", function LookupAccountTypesPage_p_table_54_ng_template_2_td_9_Template_button_click_2_listener() { i0.ɵɵrestoreView(_r3); const row_r4 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.openEdit(row_r4)); });
    i0.ɵɵelement(3, "i", 68);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(4, "button", 69);
    i0.ɵɵlistener("click", function LookupAccountTypesPage_p_table_54_ng_template_2_td_9_Template_button_click_4_listener() { i0.ɵɵrestoreView(_r3); const row_r4 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.deleteItem(row_r4)); });
    i0.ɵɵelement(5, "i", 70);
    i0.ɵɵelementEnd()()();
} }
function LookupAccountTypesPage_p_table_54_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "tr", 60)(1, "td")(2, "strong");
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(4, "td");
    i0.ɵɵtemplate(5, LookupAccountTypesPage_p_table_54_ng_template_2_p_tag_5_Template, 1, 1, "p-tag", 61)(6, LookupAccountTypesPage_p_table_54_ng_template_2_p_tag_6_Template, 1, 1, "p-tag", 62);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(7, "td");
    i0.ɵɵtext(8);
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(9, LookupAccountTypesPage_p_table_54_ng_template_2_td_9_Template, 6, 0, "td", 63);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function LookupAccountTypesPage_p_table_54_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "tr")(1, "td", 71);
    i0.ɵɵtext(2, "No account types configured yet.");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
...
function LookupAccountTypesPage_p_table_54_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p-table", 54);
    i0.ɵɵtemplate(1, LookupAccountTypesPage_p_table_54_ng_template_1_Template, 8, 1, "ng-template", 55)(2, LookupAccountTypesPage_p_table_54_ng_template_2_Template, 10, 5, "ng-template", 56)(3, LookupAccountTypesPage_p_table_54_ng_template_3_Template, 3, 1, "ng-template", 57);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
export class LookupAccountTypesPage {
    ...
    static ɵfac = function LookupAccountTypesPage_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || LookupAccountTypesPage)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: LookupAccountTypesPage, selectors: [["app-lookup-account-types-page"]], decls: 78, vars: 19, consts: [[1, "page-container"], [1, "bg-orbs"], [1, "orb", "orb-1"], [1, "orb", "orb-2"], [1, "orb", "orb-3"], [1, "hero-section"], [1, "hero-content"], ["routerLink", "/app/settings", 1, "back-link"], [1, "pi", "pi-arrow-left"], [1, "hero-badge"], [1, "badge-dot"], [1, "hero-title"], [1, "title-gradient"], [1, "title-light"], [1, "hero-description"], [1, "hero-visual"], [1, "visual-card", "visual-card--primary"], [1, "card-icon"], [1, "pi", "pi-briefcase"], [1, "card-content"], [1, "card-label"], [1, "card-value"], [1, "card-glow"], [1, "visual-card", "visual-card--success"], [1, "pi", "pi-check-circle"], [1, "data-section"], [1, "data-card"], [1, "data-header"], [1, "header-actions"], ["type", "button", 1, "action-btn", "action-btn--refresh", 3, "click", "disabled"], [1, "action-btn__icon"], [1, "pi", "pi-refresh"], ["type", "button", "class", "action-btn action-btn--add", 3, "click", 4, "ngIf"], ["class", "skeleton-rows", 4, "ngIf"], ["styleClass", "p-datatable-sm", 3, "value", "rows", "paginator", "rowHover", "tableStyle", 4, "ngIf"], [3, "visibleChange", "onHide", "header", "visible", "modal", "closable", "draggable"], [3, "ngSubmit", "formGroup"], [1, "dialog-body"], [1, "form-field"], ["for", "lu-name"], [1, "required"], [1, "icon-addon", "icon-addon--company"], ["pInputText", "", "id", "lu-name", "formControlName", "name", "placeholder", "e.g. Customer"], ["for", "lu-sort"], ["id", "lu-sort", "formControlName", "sortOrder", 3, "min", "showButtons"], ["formControlName", "isActive", "label", "Active", 3, "binary"], [1, "dialog-footer"], ["type", "button", "pButton", "", "label", "Cancel", 1, "p-button-text", 3, "click"], ["type", "submit", "pButton", "", "label", "Save", "icon", "pi pi-check", 3, "loading"], ["type", "button", 1, "action-btn", "action-btn--add", 3, "click"], [1, "pi", "pi-plus"], [1, "skeleton-rows"], ["height", "3rem", "styleClass", "mb-2", 4, "ngFor", "ngForOf"], ["height", "3rem", "styleClass", "mb-2"], ["styleClass", "p-datatable-sm", 3, "value", "rows", "paginator", "rowHover", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], ["style", "width: 7rem", 4, "ngIf"], [2, "width", "7rem"], [1, "table-row"], ["severity", "success", "value", "Active", 3, "rounded", 4, "ngIf"], ["severity", "warn", "value", "Inactive", 3, "rounded", 4, "ngIf"], [4, "ngIf"], ["severity", "success", "value", "Active", 3, "rounded"], ["severity", "warn", "value", "Inactive", 3, "rounded"], [1, "row-actions"], ["type", "button", "title", "Edit", 1, "row-action-btn", "row-action-btn--edit", 3, "click"], [1, "pi", "pi-pencil"], ["type", "button", "title", "Delete", 1, "row-action-btn", "row-action-btn--delete", 3, "click"], [1, "pi", "pi-trash"], [1, "empty-message"]], template: function LookupAccountTypesPage_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵtext(21, "Manage account classification types used across customer records.");
            i0.ɵɵelementEnd()();
            ...
            i0.ɵɵtext(45, "Account Type List");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(46, "div", 28)(47, "button", 29);
            i0.ɵɵlistener("click", function LookupAccountTypesPage_Template_button_click_47_listener() { return ctx.loadItems(); });
            ...
            i0.ɵɵelementEnd()();
            i0.ɵɵtemplate(52, LookupAccountTypesPage_button_52_Template, 5, 0, "button", 32);
            i0.ɵɵelementEnd()();
            i0.ɵɵtemplate(53, LookupAccountTypesPage_div_53_Template, 2, 2, "div", 33)(54, LookupAccountTypesPage_p_table_54_Template, 4, 6, "p-table", 34);
            i0.ɵɵelementEnd()()();
            i0.ɵɵelementStart(55, "p-dialog", 35);
            i0.ɵɵtwoWayListener("visibleChange", function LookupAccountTypesPage_Template_p_dialog_visibleChange_55_listener($event) { i0.ɵɵtwoWayBindingSet(ctx.editorOpen, $event) || (ctx.editorOpen = $event); return $event; });
            i0.ɵɵlistener("onHide", function LookupAccountTypesPage_Template_p_dialog_onHide_55_listener() { return ctx.closeEditor(); });
            i0.ɵɵelementStart(56, "form", 36);
            i0.ɵɵlistener("ngSubmit", function LookupAccountTypesPage_Template_form_ngSubmit_56_listener() { return ctx.save(); });
            ...
            i0.ɵɵlistener("click", function LookupAccountTypesPage_Template_button_click_76_listener() { return ctx.closeEditor(); });
            i0.ɵɵelementEnd();
            ...
            i0.ɵɵproperty("header", ctx.editing() ? "Edit Account Type" : "New Account Type");
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(LookupAccountTypesPage, [{
        type: Component,
        args: [{ selector: 'app-lookup-account-types-page', standalone: true, imports: [
