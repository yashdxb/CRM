...
export const routes = [
    ...
    {
        path: 'platform',
        loadComponent: () => import('./public/product-capabilities/product-capabilities.page').then((m) => m.ProductCapabilitiesPage)
    },
    {
        path: 'login',
    ...
    },
    {
        ...
        loadComponent: () => import('./public/supplier/supplier-onboarding.page').then((m) => m.SupplierOnboardingPage)
    },
    {
    ...
    {
        path: 'unsubscribe',
        loadComponent: () => import('./public/email-unsubscribe/email-unsubscribe.page').then((m) => m.EmailUnsubscribePage)
    },
    {
        path: 'app',
        ...
        children: [
            { path: '', pathMatch: 'full', redirectTo: 'dashboard' },
            {
                ...
                loadComponent: () => import('./crm/features/dashboard/pages/dashboard.page').then((m) => m.DashboardPage)
            },
            {
                path: 'risk-intelligence',
                canActivate: [roleGuard],
                data: { permission: PERMISSION_KEYS.dashboardView, breadcrumb: 'Risk Intelligence', icon: 'pi-shield' },
                loadComponent: () => import('./crm/features/risk-intelligence/pages/risk-intelligence.page').then((m) => m.RiskIntelligencePage)
            },
            {
                path: 'reports',
                canActivate: [roleGuard],
                data: { permission: PERMISSION_KEYS.reportsView, breadcrumb: 'Reports', icon: 'pi-chart-pie' },
                loadComponent: () => import('./crm/features/reports/pages/reports.page').then((m) => m.ReportsPage)
            },
            {
                path: 'report-designer',
                canActivate: [roleGuard],
                data: { permission: PERMISSION_KEYS.reportsDesign, breadcrumb: 'Report Workspace', icon: 'pi-palette' },
                loadComponent: () => import('./crm/features/reports/pages/report-designer.page').then((m) => m.ReportDesignerPage)
            },
            {
                path: 'module-disabled',
                canActivate: [roleGuard],
                data: { permission: PERMISSION_KEYS.dashboardView, breadcrumb: 'Module Disabled', icon: 'pi-ban' },
                loadComponent: () => import('./shared/pages/module-disabled.page').then((m) => m.ModuleDisabledPage)
            },
            {
                path: 'access-denied',
                canActivate: [roleGuard],
                data: { permission: PERMISSION_KEYS.dashboardView, breadcrumb: 'Access Denied', icon: 'pi-lock' },
                loadComponent: () => import('./shared/pages/access-denied.page').then((m) => m.AccessDeniedPage)
            },
            {
                path: 'decisions',
                canActivate: [roleGuard],
                ...
                children: [
                    ...
                    {
                        path: '',
                        loadComponent: () => import('./crm/features/opportunities/pages/decision-inbox-shell.page').then((m) => m.DecisionInboxShellPage),
                        children: [
                            {
                                path: 'pending-action',
                                data: {
                                ...
                                loadComponent: () => import('./crm/features/opportunities/pages/opportunity-approvals.page').then((m) => m.OpportunityApprovalsPage)
                            },
                            {
                                path: 'inbox',
                                pathMatch: 'full',
                            ...
                            },
                            {
                                ...
                                loadComponent: () => import('./crm/features/opportunities/pages/decision-policies-sla.page').then((m) => m.DecisionPoliciesSlaPage)
                            },
                            {
                                path: 'audit',
                                data: {
                                ...
                                loadComponent: () => import('./crm/features/opportunities/pages/decision-history.page').then((m) => m.DecisionHistoryPage)
                            }
                        ]
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadComponent: () => import('./crm/features/customers/pages/customers.page').then((m) => m.CustomersPage)
                    },
                    {
                        path: 'new',
                        canActivate: [roleGuard],
                        ...
                        loadComponent: () => import('./crm/features/customers/pages/customer-form.page').then((m) => m.CustomerFormPage)
                    },
                    {
                        path: ':id',
                        data: { breadcrumb: 'Customer Detail' },
                        loadComponent: () => import('./crm/features/customers/pages/customer-detail.page').then((m) => m.CustomerDetailPage)
                    },
                    {
                        path: ':id/edit',
                        canActivate: [roleGuard],
                ...
                children: [
                    {
                        path: '',
                        pathMatch: 'full',
                        loadComponent: () => import('./crm/features/contacts/pages/contacts.page').then((m) => m.ContactsPage)
                    },
                    {
                        path: 'new',
                        canActivate: [roleGuard],
                        ...
                        loadComponent: () => import('./crm/features/contacts/pages/contact-form.page').then((m) => m.ContactFormPage)
                    },
                    {
                        path: ':id/edit',
                        canActivate: [roleGuard],
            ...
            },
            {
                ...
                loadComponent: () => import('./crm/features/opportunities/pages/opportunity-form.page').then((m) => m.OpportunityFormPage)
            },
            {
            ...
            },
            {
                ...
                loadComponent: () => import('./crm/features/opportunities/pages/opportunity-detail.page').then((m) => m.OpportunityDetailPage)
            },
            {
                path: 'deals',
                canActivate: [roleGuard],
                data: { permission: PERMISSION_KEYS.opportunitiesView, breadcrumb: 'Deals', icon: 'pi-chart-line' },
                loadComponent: () => import('./crm/features/opportunities/pages/opportunities.page').then((m) => m.OpportunitiesPage)
            },
            {
                path: 'deals/pipeline',
                canActivate: [roleGuard],
            ...
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadComponent: () => import('./crm/features/properties/pages/properties.page').then((m) => m.PropertiesPage)
                    },
                    {
                        path: 'new',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.propertiesManage, breadcrumb: 'New Property' },
                        loadComponent: () => import('./crm/features/properties/pages/property-form.page').then((m) => m.PropertyFormPage)
                    },
                    {
                        path: ':id/edit',
                        canActivate: [roleGuard],
                    ...
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/properties/pages/property-detail.page').then((m) => m.PropertyDetailPage)
                    }
                ]
            },
            {
                ...
                loadComponent: () => import('./crm/features/marketing/pages/campaigns.page').then((m) => m.CampaignsPage)
            },
            {
                ...
                loadComponent: () => import('./crm/features/marketing/pages/campaign-form.page').then((m) => m.CampaignFormPage)
            },
            {
            ...
            },
            {
                ...
                loadComponent: () => import('./crm/features/marketing/pages/campaign-detail.page').then((m) => m.CampaignDetailPage)
            },
            {
                ...
                loadComponent: () => import('./crm/features/marketing/pages/campaign-attribution.page').then((m) => m.CampaignAttributionPage)
            },
            {
                ...
                loadComponent: () => import('./crm/features/marketing/pages/campaign-emails.page').then((m) => m.CampaignEmailsPage)
            },
            {
                ...
                loadComponent: () => import('./crm/features/marketing/pages/campaign-email-form.page').then((m) => m.CampaignEmailFormPage)
            },
            {
            ...
            },
            {
                ...
                loadComponent: () => import('./crm/features/marketing/pages/campaign-email-detail.page').then((m) => m.CampaignEmailDetailPage)
            },
            {
                path: 'helpdesk/cases',
                canActivate: [roleGuard, tenantFeatureGuard],
                ...
                loadComponent: () => import('./crm/features/helpdesk/pages/helpdesk-cases.page').then((m) => m.HelpDeskCasesPage)
            },
            {
                ...
                loadComponent: () => import('./crm/features/helpdesk/pages/helpdesk-case-detail.page').then((m) => m.HelpDeskCaseDetailPage)
            },
            {
            ...
            },
            {
                ...
                loadComponent: () => import('./crm/features/helpdesk/pages/helpdesk-queues.page').then((m) => m.HelpDeskQueuesPage)
            },
            {
                ...
                loadComponent: () => import('./crm/features/helpdesk/pages/helpdesk-settings.page').then((m) => m.HelpDeskSettingsPage)
            },
            {
                path: 'activities',
                canActivate: [roleGuard],
                data: { permission: PERMISSION_KEYS.activitiesView, breadcrumb: 'Activities', icon: 'pi-calendar' },
                loadComponent: () => import('./crm/features/activities/pages/activities.page').then((m) => m.ActivitiesPage)
            },
            {
            ...
            },
            {
                ...
                loadComponent: () => import('./crm/features/activities/pages/activity-form.page').then((m) => m.ActivityFormPage)
            },
            {
            ...
            // ═══════════════════════════════════════════════════════════════════════
            {
                ...
                children: [
                    { path: '', pathMatch: 'full', redirectTo: 'inbox' },
                    {
                        ...
                        loadComponent: () => import('./crm/features/emails/pages/emails.page').then((m) => m.EmailsPage)
                    },
                    {
                        path: 'starred',
                    ...
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/emails/pages/email-templates.page').then((m) => m.EmailTemplatesPage)
                    },
                    {
                        path: 'compose',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.emailsManage, breadcrumb: 'Compose Email', icon: 'pi-pencil' },
                        loadComponent: () => import('./crm/features/emails/pages/email-compose.page').then((m) => m.EmailComposePage)
                    }
                ]
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/settings/pages/notifications.page').then((m) => m.NotificationsPage)
                    },
                    {
                        path: 'marketing',
                        ...
                        loadComponent: () => import('./crm/features/settings/pages/marketing-settings.page').then((m) => m.MarketingSettingsPage)
                    },
                    {
                        path: 'users/:id/edit',
                        canActivate: [roleGuard],
                    ...
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/settings/pages/qualification-policy.page').then((m) => m.QualificationPolicyPage)
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/settings/pages/qualification-thresholds.page').then((m) => m.QualificationThresholdsPage)
                    },
                    {
                    ...
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/settings/pages/opportunity-automation.page').then((m) => m.OpportunityAutomationPage)
                    },
                    {
                        path: 'deal-health',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Deal Health Scoring' },
                        loadComponent: () => import('./crm/features/settings/pages/deal-health-settings.page').then((m) => m.DealHealthSettingsPage)
                    },
                    {
                    ...
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/settings/pages/lookup-lead-statuses.page').then((m) => m.LookupLeadStatusesPage)
                    },
                    {
                        path: 'lookups/opportunity-stages',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Opportunity Stages' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-opportunity-stages.page').then((m) => m.LookupOpportunityStagesPage)
                    },
                    {
                        path: 'lookups/currencies',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Currencies' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-currencies.page').then((m) => m.LookupCurrenciesPage)
                    },
                    {
                        path: 'lookups/phone-types',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Phone Types' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-phone-types.page').then((m) => m.LookupPhoneTypesPage)
                    },
                    {
                        path: 'lookups/cadence-channels',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Cadence Channels' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-cadence-channels.page').then((m) => m.LookupCadenceChannelsPage)
                    },
                    {
                        path: 'lookups/account-types',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Account Types' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-account-types.page').then((m) => m.LookupAccountTypesPage)
                    },
                    {
                        path: 'lookups/account-sources',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Account Sources' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-account-sources.page').then((m) => m.LookupAccountSourcesPage)
                    },
                    {
                        path: 'lookups/customer-ratings',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Customer Ratings' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-customer-ratings.page').then((m) => m.LookupCustomerRatingsPage)
                    },
                    {
                        path: 'lookups/contact-buying-roles',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Contact Buying Roles' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-contact-buying-roles.page').then((m) => m.LookupContactBuyingRolesPage)
                    },
                    {
                        path: 'lookups/activity-types',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Activity Types' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-activity-types.page').then((m) => m.LookupActivityTypesPage)
                    },
                    {
                        path: 'lookups/activity-priorities',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Activity Priorities' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-activity-priorities.page').then((m) => m.LookupActivityPrioritiesPage)
                    },
                    {
                        path: 'lookups/helpdesk-case-statuses',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Case Statuses' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-helpdesk-case-statuses.page').then((m) => m.LookupHelpdeskCaseStatusesPage)
                    },
                    {
                        path: 'lookups/helpdesk-priorities',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Helpdesk Priorities' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-helpdesk-priorities.page').then((m) => m.LookupHelpdeskPrioritiesPage)
                    },
                    {
                        path: 'lookups/helpdesk-severities',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Helpdesk Severities' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-helpdesk-severities.page').then((m) => m.LookupHelpdeskSeveritiesPage)
                    },
                    {
                        path: 'lookups/helpdesk-sources',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Helpdesk Sources' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-helpdesk-sources.page').then((m) => m.LookupHelpdeskSourcesPage)
                    },
                    {
                        path: 'lookups/property-statuses',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Property Statuses' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-property-statuses.page').then((m) => m.LookupPropertyStatusesPage)
                    },
                    {
                        path: 'lookups/property-types',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Property Types' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-property-types.page').then((m) => m.LookupPropertyTypesPage)
                    },
                    {
                        path: 'lookups/deal-types',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Deal Types' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-deal-types.page').then((m) => m.LookupDealTypesPage)
                    },
                    {
                        path: 'lookups/deal-segments',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Deal Segments' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-deal-segments.page').then((m) => m.LookupDealSegmentsPage)
                    },
                    {
                        path: 'lookups/document-categories',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Document Categories' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-document-categories.page').then((m) => m.LookupDocumentCategoriesPage)
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/settings/pages/lookup-lead-disqualification-reasons.page').then((m) => m.LookupLeadDisqualificationReasonsPage)
                    },
                    {
                        path: 'lookups/lead-loss-reasons',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Lead Loss Reasons' },
                        loadComponent: () => import('./crm/features/settings/pages/lookup-lead-loss-reasons.page').then((m) => m.LookupLeadLossReasonsPage)
                    },
                    {
                        path: 'tenants/new',
                        canActivate: [roleGuard],
                ...
                children: [
                    {
                        ...
                        loadComponent: () => import('./crm/features/workflows/pages/workflow-workspace.page').then((m) => m.WorkflowWorkspacePage)
                    },
                    {
                        path: 'builder',
                        canActivate: [roleGuard],
                        data: { permission: PERMISSION_KEYS.administrationManage, breadcrumb: 'Workflow Builder' },
                        loadComponent: () => import('./crm/features/workflows/pages/workflow-builder.page').then((m) => m.WorkflowBuilderPage)
                    },
                    {
                        path: 'builder/:id',
                        canActivate: [roleGuard],
                    ...
                    },
                    {
                        ...
                        loadComponent: () => import('./crm/features/workflows/pages/workflow-execution-viewer.page').then((m) => m.WorkflowExecutionViewerPage)
                    }
                ]
            }
        ]
