...
import { AccountSourceItem, LookupDataService } from '../services/lookup-data.service';
...
@Component({
  selector: 'app-lookup-account-sources-page',
  standalone: true,
  imports: [
  ...
  templateUrl: './lookup-account-sources.page.html',
  styleUrl: './lookup-account-sources.page.scss'
})
export class LookupAccountSourcesPage {
  ...
  protected readonly items = signal<AccountSourceItem[]>([]);
  protected readonly loading = signal(true);
  protected readonly saving = signal(false);
  protected readonly editorOpen = signal(false);
  protected readonly editing = signal<AccountSourceItem | null>(null);
  ...
  protected openEdit(item: AccountSourceItem) {
  ...
  protected deleteItem(item: AccountSourceItem) {
