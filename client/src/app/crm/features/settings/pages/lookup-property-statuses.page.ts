...
import { PropertyStatusItem, LookupDataService } from '../services/lookup-data.service';
...
@Component({
  selector: 'app-lookup-property-statuses-page',
  standalone: true,
  imports: [
  ...
  templateUrl: './lookup-property-statuses.page.html',
  styleUrl: './lookup-property-statuses.page.scss'
})
export class LookupPropertyStatusesPage {
  ...
  protected readonly items = signal<PropertyStatusItem[]>([]);
  protected readonly loading = signal(true);
  protected readonly saving = signal(false);
  protected readonly editorOpen = signal(false);
  protected readonly editing = signal<PropertyStatusItem | null>(null);
  ...
  protected openEdit(item: PropertyStatusItem) {
  ...
  protected deleteItem(item: PropertyStatusItem) {
