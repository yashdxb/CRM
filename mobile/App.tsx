...
type TabKey = 'home' | 'contacts' | 'add' | 'deals' | 'more';
...
const tabs: {
  ...
  { key: 'add', label: '', icon: 'add', isFab: true },
...
function AppShell() {
  ...
  const switchTab = (tab: TabKey) => {
    if (tab === activeTab || tab === 'add') return;
    Animated.parallel([
      ...
      <SafeAreaView style={styles.screen}>
        ...
        <View style={styles.appShell}>
          ...
          >
            ...
            {activeTab === 'more' ? <LeadsScreen key={refreshKey} /> : null}
          </Animated.ScrollView>
