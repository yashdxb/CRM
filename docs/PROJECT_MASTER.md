...
- `Conversation Score` is now an active in-progress lead capability derived from lead-related email, call, meeting, and activity evidence.
- Ordered next work for leads:
  1. conversion-readiness hardening
  2. manager coaching rollups
  3. disqualify/recycle reporting
  4. lead-source quality and attribution
  5. deduplication / merge that preserves qualification and conversation evidence
...
- **Primary source of truth** for backlog status/prioritization is ClickUp.
...
- Repo docs are mirrors/snapshots for in-repo visibility:
  - `docs/CRM_BACKLOG.md`
