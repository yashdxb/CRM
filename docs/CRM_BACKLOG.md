...
- Activities | As a Sales Rep, I want every activity to require an outcome and a next step with due date, ensuring pipeline hygiene. (ClickUp: 86dzp8x9n, Status: COMPLETED) Flow: 05
  - Acceptance criteria:
...
- Activities | As a Sales Rep, I want quick actions (log activity, create task, schedule meeting) from the home view to reduce friction. (ClickUp: 86dzp8xdt, Status: COMPLETED) Flow: 05
  - Acceptance criteria:
...
- Activities | As a Sales Rep, I want review outcomes (Needs Work / Escalate) to create acknowledgment tasks with due dates. (ClickUp: 86dzp8x97, Status: COMPLETED) Flow: 05
  - Acceptance criteria:
...
- Activities | As a Sales Rep, I want the system to surface opportunities missing next steps. (ClickUp: 86dzp8x9k, Status: COMPLETED) Flow: 05
  - Acceptance criteria:
...
- Activities | As a system, automation creates tasks for unresolved high-impact factors (ClickUp: 86dzp8xyj, Status: COMPLETED) Flow: 05
  - Acceptance criteria:
  ...
  - Evidence:
    - UI: client/src/app/crm/features/activities/pages/activity-form.page.html
- Contacts | As a Sales Rep, I want to add account team members (pre‑sales, manager) for shared ownership. (ClickUp: 86dzp8xcg, Status: COMPLETED) Flow: 03
  - Acceptance criteria:
...
- Contacts | As a Sales Rep, I want to see account history and related accounts so I can avoid duplication and understand context. (ClickUp: 86dzp8xcw, Status: COMPLETED) Flow: 03
  - Acceptance criteria:
  ...
  - Evidence:
- Contacts | As a Sales Rep, I want to tag contacts by buying role (Decision Maker, Champion, Influencer, Procurement, Technical Evaluator) to map the buying group. (ClickUp: 86dzp8xcr, Status: COMPLETED) Flow: 03
  - Acceptance criteria:
...
- Dashboard | As a Sales Manager, I can see Truth Coverage and Time-to-Truth per deal (ClickUp: 86dzp8y0j, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Manager, I see top truth gaps across pipeline (ClickUp: 86dzp8y02, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Manager, I want pipeline and forecast rollups across my role hierarchy by default. (ClickUp: 86dzpgeq0, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I can view Risk Register flags derived from CQVS (ClickUp: 86dzp8xzq, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want a structured checklist to flag risks early. (ClickUp: 86dzp8xbh, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want personal pipeline and forecast reports to track progress to quota. (ClickUp: 86dzp8x8g, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want renewal opportunities auto‑created at 90/60/30 days so renewal motions are never missed. (ClickUp: 86dzp8x92, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
...
- Dashboard | As a Sales Rep, I want the CRM to guide execution, not just store data — enforcing discipline, protecting forecast accuracy, and enabling clean handoffs. (ClickUp: 86dzp8x89, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want to capture requirements, buying process, and success criteria to qualify fit. (ClickUp: 86dzp8xbp, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
...
- Dashboard | As a Sales Rep, I want to confirm pain, decision maker, and next step before advancing. (ClickUp: 86dzp8xc1, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
    - UI: client/src/app/crm/features/dashboard/pages/dashboard.page.html
- Dashboard | As a Sales Rep, I want to flag expansion signals and create expansion opportunities with linked context. (ClickUp: 86dzp8x8p, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want to generate a quote/proposal, request discounts if needed, and track legal/security needs. (ClickUp: 86dzp8xat, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want to involve pre‑sales and document scope/approach for alignment. (ClickUp: 86dzp8xb6, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want to provide handoff notes and trigger a kickoff. (ClickUp: 86dzp8x9z, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want to track security questionnaire and legal redlines with status updates. (ClickUp: 86dzp8xan, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As a Sales Rep, I want to track technical risks before demo/validation. (ClickUp: 86dzp8xb3, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | As an Executive, I can view confidence-weighted pipeline totals (ClickUp: 86dzp8y09, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
  ...
  - Evidence:
- Dashboard | Confidence-weighted forecast card (ClickUp: 86dzp8xed, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
...
- Dashboard | Epistemic summary widgets (Truth Coverage, Confidence, Time-to-Truth) (ClickUp: 86dzp8xen, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
...
- Dashboard | Risk Register summary widget (ClickUp: 86dzp8xef, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
    - Dashboard shows total risk flag count and top risk labels.
    - Clicking a flag filters/links to the related deal or lead.
- Dashboard | Hierarchy-based H1/H2 dashboard packs + reset (ClickUp: 86dzp8xea, Status: COMPLETED) Flow: 06
  - Acceptance criteria:
...
- Leads | As a Sales Manager, I want the CQVS score breakdown to show labeled factors (C/Q/V/S) with per‑factor scores and weights so I can see why a lead is rated and coach reps on weak factors. (ClickUp: 86dzp8y10, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
  ...
  - Evidence:
- Leads | As a Sales Rep, AI suggests next evidence to resolve weakest signal (ClickUp: 86dzp8xz6, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
  ...
  - Evidence:
- Leads | As a Sales Rep, evidence is disabled when a factor is Unknown and locked to "No evidence yet" (ClickUp: 86dzp8y1d, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
  ...
  - Evidence:
- Leads | As a Sales Rep, I see "Unknown / not yet discussed" preselected for every qualification factor (ClickUp: 86dzp8y1u, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
  ...
  - Evidence:
- Leads | As a Sales Rep, I want an inline qualification summary on the lead detail that shows overall confidence and the weakest signal so I can see what is uncertain and fix it quickly. (ClickUp: 86dzp8y19, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
  ...
  - Evidence:
- Leads | As a Sales Rep, I want a daily command center showing tasks due/overdue, new leads, pipeline by stage, at‑risk deals, and my forecast snapshot so I can prioritize work immediately. (ClickUp: 86dzp8xe0, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
...
- Leads | As a Sales Rep, I want a single conversion action that creates Account + Contact + Opportunity and transfers activities/notes. (ClickUp: 86dzp8xd2, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
...
- Leads | As a Sales Rep, I want lead outcomes enforced (Disqualified reason, Nurture follow‑up date, Qualified notes) to keep data clean. (ClickUp: 86dzp8xd5, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
  ...
  - Evidence:
    - UI: client/src/app/crm/features/leads/pages/lead-form.page.html
- Leads | As a Sales Rep, I want new leads automatically assigned with an SLA timer and first‑touch task so I never miss initial outreach. (ClickUp: 86dzp8xdn, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
  ...
  - Evidence:
    - UI: client/src/app/crm/features/leads/pages/lead-form.page.html
- Leads | As a Sales Rep, I want the lead record to show source, score, and routing reason so I can tailor outreach. (ClickUp: 86dzp8xdm, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
    - Lead detail displays `source`, `aiScore`, and `routingReason`.
    - Score and rationale refresh when key fields change.
  - Evidence:
    - UI: client/src/app/crm/features/leads/pages/lead-form.page.html
- Leads | As a Sales Rep, I want the lead to close automatically after conversion to avoid duplicate work. (ClickUp: 86dzp8xcz, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
    - Converting a lead sets status to Closed/Converted.
    - Converted leads are excluded from active lead lists.
  - Evidence:
    - UI: client/src/app/crm/features/leads/pages/lead-form.page.html
- Leads | As a Sales Rep, I want to log outcomes (Connected / Voicemail / No Response) and next steps so my pipeline is always up to date. (ClickUp: 86dzp8xdf, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
    - Activity form provides outcome options and requires selection.
    - Next-step fields are required and create follow-up activity.
  - Evidence:
    - UI: client/src/app/crm/features/leads/pages/lead-form.page.html
- Leads | As a Sales Rep, I want to qualify leads by company fit, authority, need, and timing so only real opportunities move forward. (ClickUp: 86dzp8xd6, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
...
- Leads | As a Sales Rep, I want to record loss reason, competitor, and notes so leadership can analyze trends. (ClickUp: 86dzp8x9q, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
  ...
  - Evidence:
- Leads | Configurable qualification policy + conversion guardrails (ClickUp: 86dzp8xe3, Status: COMPLETED) Flow: 02
  - Acceptance criteria:
...
- Opportunities | As a Sales Rep, I want alerts for deals with no next step or no activity in X days so I can recover risk early. (ClickUp: 86dzp8xdx, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
...
- Opportunities | As a Sales Rep, I want forecast category enforced at stage changes so forecasts stay accurate. (ClickUp: 86dzp8xcc, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
  ...
  - Evidence:
    - UI: client/src/app/crm/features/opportunities/pages/opportunity-form.page.html
- Opportunities | As a Sales Rep, I want insights on deals without activity or next steps so I can fix gaps early. (ClickUp: 86dzp8x8e, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
...
- Opportunities | As a Sales Rep, I want renewal tasks created and tracked like any opportunity. (ClickUp: 86dzp8x8w, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
    - Renewal reminder tasks are created at 90/60/30 days.
    - Tasks are linked to the renewal opportunity and appear in Activities.
- Opportunities | As a Sales Rep, I want stage‑specific activity templates so I can log actions faster. (ClickUp: 86dzp8xc4, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
...
- Opportunities | As a Sales Rep, I want stage‑specific exit criteria (required fields, next step) so stage progression reflects reality. (ClickUp: 86dzp8xc7, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
    - Stage change validates required fields for the target stage.
    - Missing requirements block save with inline errors.
  - Evidence:
    - UI: client/src/app/crm/features/opportunities/pages/opportunity-form.page.html
- Opportunities | As a Sales Rep, I want the system to create onboarding tasks, assign delivery/CS, set renewal date, and lock the deal. (ClickUp: 86dzp8xa7, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
  ...
  - Evidence:
- Opportunities | As a Sales Rep, I want to capture demo outcomes and feedback; stage progression should require a demo outcome. (ClickUp: 86dzp8xav, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
  ...
  - Evidence:
    - UI: client/src/app/crm/features/opportunities/pages/opportunity-form.page.html
- Opportunities | As a Sales Rep, I want to mark deals as Commit only when verified and expected to close. (ClickUp: 86dzp8xa9, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
...
- Opportunities | As a Sales Rep, I want to schedule discovery and log notes before leaving the stage. (ClickUp: 86dzp8xbq, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
  ...
  - Evidence:
    - UI: client/src/app/crm/features/opportunities/pages/opportunity-form.page.html
- Opportunities | As a Sales Rep, I want to set opportunity name, value, close date, and initial stage so the deal is trackable from day one. (ClickUp: 86dzp8xce, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
...
- Opportunities | As an Admin, I want stage automation rules that create tasks on stage entry. (ClickUp: 86dzpgepx, Status: COMPLETED) Flow: 04
  - Acceptance criteria:
...
- Settings | Approval Settings page (ClickUp: 86dzpdf2f, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
  ...
  - Evidence:
- Settings | As a Sales Rep, I want to finalize pricing, record objections, and update probability/close date with approvals if thresholds are exceeded. (ClickUp: 86dzp8xah, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
...
- Settings | As a Sales Rep, I want to submit pricing/discount approvals and see status + manager feedback. (ClickUp: 86dzp8x9c, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
...
- Settings | As an Admin, I want currencies sourced from the system reference data so selectors stay consistent. (ClickUp: 86dzq0q00, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
  ...
  - Evidence:
- Settings | As an Admin, I want policy gates for high-risk actions (discount %, deal size, stage gates) so enforcement is consistent. (ClickUp: 86dzpf90r, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
...
- Settings | Capability-first permission model with role intent views (ClickUp: 86dzpfc1e, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
...
- Settings | Role drift + pack presets (ClickUp: 86dzpfc1x, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
    - Role summary shows drift count vs default pack.
    - Admin can reset role to default pack preset.
- Settings | Role hierarchy (Salesforce-style reporting structure) (ClickUp: 86dzpegw4, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
  ...
  - Evidence:
- Settings | Contextual Threshold Rules page (ClickUp: 86dzpdf2h, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
  ...
  - Evidence:
- Settings | Qualification Policy page (ClickUp: 86dzpdf2g, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
  ...
  - Evidence:
- Settings | As a user, I want configurable email alert types and thresholds. (ClickUp: 86dzpgja2, Status: COMPLETED) Flow: 07
  - Acceptance criteria:
  ...
  - Evidence:
  - Dashboard | As a Sales Manager, I want a deal-level Cost of Not Knowing breakdown so I can see which missing factors drive exposure. (ClickUp: 86dzpr31w, Status: COMPLETED) Flow: 06
    - Acceptance criteria:
    ...
    - Evidence:
  - Dashboard | As a Sales Manager, I want an exposure rollup with drill-down to the top contributing deals so I can focus coaching. (ClickUp: 86dzpr32x, Status: COMPLETED) Flow: 06
    - Acceptance criteria:
    ...
    - Evidence:
  - Dashboard | As a Sales Manager, I want an exposure trend line (4–8 weeks) to see if uncertainty is improving or worsening. (ClickUp: 86dzpr337, Status: COMPLETED) Flow: 06
    - Acceptance criteria:
    ...
    - Evidence:
  - Settings | As an admin, I want configurable exposure weights per qualification factor so Cost of Not Knowing reflects my business. (ClickUp: 86dzpr33p, Status: COMPLETED) Flow: 07
    - Acceptance criteria:
