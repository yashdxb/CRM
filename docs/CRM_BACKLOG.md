...
- Module: Dashboard | As a manager, I can see Truth Coverage and Time-to-Truth per deal (ClickUp: 86dzp8y0j, Status: done) Flow: 06
- Module: Dashboard | As a manager, I can see Truth Coverage and Time-to-Truth per deal (ClickUp: 86dzp8xtg, Status: done) Flow: 06
- Module: Dashboard | As a manager, I see top truth gaps across pipeline (ClickUp: 86dzp8y02, Status: done) Flow: 06
- Module: Dashboard | As a manager, I see top truth gaps across pipeline (ClickUp: 86dzp8xt8, Status: done) Flow: 06
- Module: Dashboard | As a manager, I want pipeline and forecast rollups across my role hierarchy by default. (ClickUp: 86dzpgeq0, Status: done) Flow: 06
- Module: Dashboard | As a rep, I can view Risk Register flags derived from CQVS (ClickUp: 86dzp8xzq, Status: done) Flow: 06
- Module: Dashboard | As a rep, I can view Risk Register flags derived from CQVS (ClickUp: 86dzp8xt5, Status: done) Flow: 06
...
- Module: Leads | As a rep, evidence is disabled when a factor is Unknown and locked to "No evidence yet" (ClickUp: 86dzp8y1d, Status: done) Flow: 02
...
- Risk & Cost of Not Knowing (ClickUp: 86dzp8xf4, Status: done)
  - Module: Dashboard | As a manager, I want a deal-level Cost of Not Knowing breakdown so I can see which missing factors drive exposure. (ClickUp: 86dzpr31w, Status: done) Flow: 06
    - Acceptance criteria:
  ...
  - Module: Dashboard | As a manager, I want an exposure rollup with drill-down to the top contributing deals so I can focus coaching. (ClickUp: 86dzpr32x, Status: done) Flow: 06
    - Acceptance criteria:
  ...
  - Module: Dashboard | As a manager, I want an exposure trend line (4–8 weeks) to see if uncertainty is improving or worsening. (ClickUp: 86dzpr337, Status: done) Flow: 06
    - Acceptance criteria:
