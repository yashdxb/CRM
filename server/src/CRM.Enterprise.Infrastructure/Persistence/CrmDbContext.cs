...
public class CrmDbContext : DbContext
{
    ...
    public DbSet<AccountSourceDefinition> AccountSources => Set<AccountSourceDefinition>();
    public DbSet<CustomerRatingDefinition> CustomerRatings => Set<CustomerRatingDefinition>();
    public DbSet<ContactBuyingRoleDefinition> ContactBuyingRoles => Set<ContactBuyingRoleDefinition>();
    public DbSet<ActivityTypeDefinition> ActivityTypes => Set<ActivityTypeDefinition>();
    public DbSet<ActivityPriorityDefinition> ActivityPriorities => Set<ActivityPriorityDefinition>();
    public DbSet<HelpdeskCaseStatusDefinition> HelpdeskCaseStatuses => Set<HelpdeskCaseStatusDefinition>();
    public DbSet<HelpdeskPriorityDefinition> HelpdeskPriorities => Set<HelpdeskPriorityDefinition>();
    public DbSet<HelpdeskSeverityDefinition> HelpdeskSeverities => Set<HelpdeskSeverityDefinition>();
    public DbSet<HelpdeskSourceDefinition> HelpdeskSources => Set<HelpdeskSourceDefinition>();
    public DbSet<PropertyStatusDefinition> PropertyStatuses => Set<PropertyStatusDefinition>();
    public DbSet<PropertyTypeDefinition> PropertyTypes => Set<PropertyTypeDefinition>();
    public DbSet<DealTypeDefinition> DealTypes => Set<DealTypeDefinition>();
    public DbSet<DealSegmentDefinition> DealSegments => Set<DealSegmentDefinition>();
    public DbSet<DocumentCategoryDefinition> DocumentCategories => Set<DocumentCategoryDefinition>();
    public DbSet<LeadDisqualificationReasonDefinition> LeadDisqualificationReasons => Set<LeadDisqualificationReasonDefinition>();
    public DbSet<LeadLossReasonDefinition> LeadLossReasons => Set<LeadLossReasonDefinition>();
