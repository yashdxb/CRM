...
public class DatabaseInitializer : IDatabaseInitializer
{
    ...
    private async Task SeedTimeZonesAsync(CancellationToken cancellationToken)
    {
        ...
        var timeZones = new[]
        {
            ...
            new TimeZoneDefinition { IanaId = "Asia/Colombo", Label = "Colombo, Sri Lanka (GMT+05:30)", UtcOffsetMinutes = 330, FlagCode = "lk", IsActive = true, SortOrder = 18 },
            new TimeZoneDefinition { IanaId = "Asia/Dubai", Label = "Dubai, United Arab Emirates (GMT+04:00)", UtcOffsetMinutes = 240, FlagCode = "ae", IsActive = true, SortOrder = 19 },
            new TimeZoneDefinition { IanaId = "Europe/Istanbul", Label = "Istanbul, Turkey (GMT+03:00)", UtcOffsetMinutes = 180, FlagCode = "tr", IsActive = true, SortOrder = 20 },
            new TimeZoneDefinition { IanaId = "Asia/Riyadh", Label = "Riyadh, Saudi Arabia (GMT+03:00)", UtcOffsetMinutes = 180, FlagCode = "sa", IsActive = true, SortOrder = 21 },
            new TimeZoneDefinition { IanaId = "Europe/Moscow", Label = "Moscow, Russia (GMT+03:00)", UtcOffsetMinutes = 180, FlagCode = "ru", IsActive = true, SortOrder = 22 },
            new TimeZoneDefinition { IanaId = "Africa/Johannesburg", Label = "Johannesburg, South Africa (GMT+02:00)", UtcOffsetMinutes = 120, FlagCode = "za", IsActive = true, SortOrder = 23 },
            new TimeZoneDefinition { IanaId = "Asia/Jerusalem", Label = "Jerusalem, Israel (GMT+02:00)", UtcOffsetMinutes = 120, FlagCode = "il", IsActive = true, SortOrder = 24 },
            new TimeZoneDefinition { IanaId = "Europe/Berlin", Label = "Berlin, Germany (GMT+01:00)", UtcOffsetMinutes = 60, FlagCode = "de", IsActive = true, SortOrder = 25 },
            new TimeZoneDefinition { IanaId = "Europe/Rome", Label = "Rome, Italy (GMT+01:00)", UtcOffsetMinutes = 60, FlagCode = "it", IsActive = true, SortOrder = 26 },
            new TimeZoneDefinition { IanaId = "Europe/Paris", Label = "Paris, France (GMT+01:00)", UtcOffsetMinutes = 60, FlagCode = "fr", IsActive = true, SortOrder = 27 },
            new TimeZoneDefinition { IanaId = "Europe/Madrid", Label = "Madrid, Spain (GMT+01:00)", UtcOffsetMinutes = 60, FlagCode = "es", IsActive = true, SortOrder = 28 },
            new TimeZoneDefinition { IanaId = "Europe/Amsterdam", Label = "Amsterdam, Netherlands (GMT+01:00)", UtcOffsetMinutes = 60, FlagCode = "nl", IsActive = true, SortOrder = 29 },
            new TimeZoneDefinition { IanaId = "Europe/Stockholm", Label = "Stockholm, Sweden (GMT+01:00)", UtcOffsetMinutes = 60, FlagCode = "se", IsActive = true, SortOrder = 30 },
            new TimeZoneDefinition { IanaId = "Europe/Oslo", Label = "Oslo, Norway (GMT+01:00)", UtcOffsetMinutes = 60, FlagCode = "no", IsActive = true, SortOrder = 31 },
            new TimeZoneDefinition { IanaId = "Europe/London", Label = "London, United Kingdom (GMT+00:00)", UtcOffsetMinutes = 0, FlagCode = "gb", IsActive = true, SortOrder = 32 },
            new TimeZoneDefinition { IanaId = "America/Sao_Paulo", Label = "Sao Paulo, Brazil (GMT-03:00)", UtcOffsetMinutes = -180, FlagCode = "br", IsActive = true, SortOrder = 33 },
            new TimeZoneDefinition { IanaId = "America/Argentina/Buenos_Aires", Label = "Buenos Aires, Argentina (GMT-03:00)", UtcOffsetMinutes = -180, FlagCode = "ar", IsActive = true, SortOrder = 34 },
            new TimeZoneDefinition { IanaId = "America/St_Johns", Label = "St. John's, Canada (GMT-03:30)", UtcOffsetMinutes = -210, FlagCode = "ca", IsActive = true, SortOrder = 35 },
            new TimeZoneDefinition { IanaId = "America/Halifax", Label = "Halifax, Canada (GMT-04:00)", UtcOffsetMinutes = -240, FlagCode = "ca", IsActive = true, SortOrder = 36 },
            new TimeZoneDefinition { IanaId = "America/Santiago", Label = "Santiago, Chile (GMT-04:00)", UtcOffsetMinutes = -240, FlagCode = "cl", IsActive = true, SortOrder = 37 },
            new TimeZoneDefinition { IanaId = "America/Toronto", Label = "Toronto, Canada (GMT-05:00)", UtcOffsetMinutes = -300, FlagCode = "ca", IsActive = true, SortOrder = 38 },
            new TimeZoneDefinition { IanaId = "America/New_York", Label = "New York, United States (GMT-05:00)", UtcOffsetMinutes = -300, FlagCode = "us", IsActive = true, SortOrder = 39 },
            new TimeZoneDefinition { IanaId = "America/Bogota", Label = "Bogota, Colombia (GMT-05:00)", UtcOffsetMinutes = -300, FlagCode = "co", IsActive = true, SortOrder = 40 },
            new TimeZoneDefinition { IanaId = "America/Lima", Label = "Lima, Peru (GMT-05:00)", UtcOffsetMinutes = -300, FlagCode = "pe", IsActive = true, SortOrder = 41 },
            new TimeZoneDefinition { IanaId = "America/Winnipeg", Label = "Winnipeg, Canada (GMT-06:00)", UtcOffsetMinutes = -360, FlagCode = "ca", IsActive = true, SortOrder = 42 },
            new TimeZoneDefinition { IanaId = "America/Chicago", Label = "Chicago, United States (GMT-06:00)", UtcOffsetMinutes = -360, FlagCode = "us", IsActive = true, SortOrder = 43 },
            new TimeZoneDefinition { IanaId = "America/Mexico_City", Label = "Mexico City, Mexico (GMT-06:00)", UtcOffsetMinutes = -360, FlagCode = "mx", IsActive = true, SortOrder = 44 },
            new TimeZoneDefinition { IanaId = "America/Edmonton", Label = "Edmonton, Canada (GMT-07:00)", UtcOffsetMinutes = -420, FlagCode = "ca", IsActive = true, SortOrder = 45 },
            new TimeZoneDefinition { IanaId = "America/Denver", Label = "Denver, United States (GMT-07:00)", UtcOffsetMinutes = -420, FlagCode = "us", IsActive = true, SortOrder = 46 },
            new TimeZoneDefinition { IanaId = "America/Vancouver", Label = "Vancouver, Canada (GMT-08:00)", UtcOffsetMinutes = -480, FlagCode = "ca", IsActive = true, SortOrder = 47 },
            new TimeZoneDefinition { IanaId = "America/Los_Angeles", Label = "Los Angeles, United States (GMT-08:00)", UtcOffsetMinutes = -480, FlagCode = "us", IsActive = true, SortOrder = 48 },
            new TimeZoneDefinition { IanaId = "America/Anchorage", Label = "Anchorage, United States (GMT-09:00)", UtcOffsetMinutes = -540, FlagCode = "us", IsActive = true, SortOrder = 49 },
            new TimeZoneDefinition { IanaId = "Pacific/Honolulu", Label = "Honolulu, United States (GMT-10:00)", UtcOffsetMinutes = -600, FlagCode = "us", IsActive = true, SortOrder = 50 }
        };
