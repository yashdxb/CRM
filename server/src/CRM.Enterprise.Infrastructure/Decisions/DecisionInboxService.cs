...
public sealed class DecisionInboxService : IDecisionInboxService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var decision = new DecisionRequest
        {
            ...
            WorkflowStepNodeId = request.WorkflowStepNodeId,
            WorkflowStepOrder = request.WorkflowStepOrder,
            WorkflowName = request.WorkflowName,
            WorkflowVersion = request.WorkflowVersion,
            WorkflowDealId = request.WorkflowDealId,
            WorkflowDealName = request.WorkflowDealName,
        ...
        return new DecisionInboxItemDto(
            ...
            request.WorkflowStepNodeId,
            request.WorkflowStepOrder,
            request.WorkflowName,
            request.WorkflowVersion,
            request.WorkflowDealId,
            request.WorkflowDealName,
    ...
    private static DecisionInboxItemDto MapLegacyInboxItem(OpportunityApprovalInboxItemDto item)
    {
        ...
        return new DecisionInboxItemDto(
            ...
            null,
            item.StepOrder <= 0 ? 1 : item.StepOrder,
            item.Purpose,
            null,
            item.OpportunityId,
            item.OpportunityName,
