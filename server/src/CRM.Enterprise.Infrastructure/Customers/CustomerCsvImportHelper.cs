...
internal static class CustomerCsvImportHelper
{
    public static async Task<IReadOnlyList<Dictionary<string, string>>> ReadAsync(Stream stream, CancellationToken cancellationToken)
    {
