...
public interface IAuthService
{
    ...
    Task<EntraSignInResult> SignInWithEntraIdTokenAsync(string idToken, CancellationToken cancellationToken = default);
    Task<PublicAuthConfig> GetPublicAuthConfigAsync(string? origin, CancellationToken cancellationToken = default);
