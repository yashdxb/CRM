...
public interface IOpportunityApprovalService
{
    ...
    Task<IReadOnlyList<OpportunityApprovalInboxItemDto>> GetInboxAsync(string? status = null, string? purpose = null, Guid? currentUserId = null, bool canApprove = false, bool canOverride = false, CancellationToken cancellationToken = default);
