...
public class OpportunitiesController : ControllerBase
{
    ...
    private static OpportunityListItem ToApiItem(OpportunityListItemDto dto)
    {
        return new OpportunityListItem(
            ...
            dto.ProposalNotes,
            dto.ProposalLink,
            dto.ProposalGeneratedAtUtc,
            dto.ProposalSentAtUtc,
            dto.PreSalesScope,
            dto.PreSalesApproach,
            dto.DeliveryOwnerId,
    ...
    private static AppOpportunityUpsertRequest MapUpsertRequest(ApiOpportunityUpsertRequest request)
    {
        return new OpportunityUpsertRequest(
            ...
            request.ProposalGeneratedAtUtc,
            request.ProposalSentAtUtc,
            request.PreSalesScope,
            request.PreSalesApproach,
